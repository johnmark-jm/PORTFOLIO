   ...
   >
    ...
    <div className='flex flex-wrap items-center justify-center gap-8 py-8'>
      {Links.map((link, index) => (
        <Link key={index} href={link.href} className='transition hover:text-gray-300'>{link.name}</Link>
      ))}
    ...
    <div className="flex flex-col items-center w-full justify-between gap-4 py-4">
        {/* <p>Build Ai agents for free</p> */}
        <p>Copyright © 2025 <a href="" target="_blank">JM</a> • Distributed by <a href="https://themewagon.com" target="_blank"></a>. All rights reservered.</p>
    </div>
